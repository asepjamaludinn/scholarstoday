...
export default function StepIllustration({
    ...
    return (
      <div className="relative flex h-44 w-full items-center justify-center">
        ...
        <div className="relative h-40 w-44 -rotate-1 rounded-2xl border border-slate-200 bg-white p-5 shadow-sm transition-transform duration-500 group-hover:-rotate-3 group-hover:-translate-y-1">
          ...
          <div className="absolute -bottom-3 -right-3 flex h-8 w-8 items-center justify-center rounded-full bg-lime-300 text-slate-900 shadow-sm">
    ...
    return (
      <div className="relative flex h-44 w-full items-center justify-center">
        ...
        <div className="relative transition-transform duration-500 group-hover:-translate-y-1">
          ...
          <div className="absolute -right-4 -top-4 flex h-11 w-11 items-center justify-center rounded-full bg-emerald-50 shadow-sm ring-1 ring-emerald-100 transition-transform duration-500 group-hover:scale-110 group-hover:rotate-6">
  ...
  return (
    <div className="relative flex h-44 w-full items-center justify-center">
      ...
      <div className="absolute right-6 top-2 flex h-9 w-9 items-center justify-center rounded-full bg-amber-300 text-slate-900 shadow-sm transition-transform duration-500 group-hover:scale-110">
